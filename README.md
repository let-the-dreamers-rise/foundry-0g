...
| **0G Chain** | EVM (Galileo testnet, chainId 16602) | ERC-7857 model NFTs, EIP-712 license signatures recorded with each purchase |
...
| Component | Status |
|---|---|
| Wallet connect (MetaMask, EIP-1193) | **Real** — auto-switches to 0G Galileo (chainId 0x40da) |
